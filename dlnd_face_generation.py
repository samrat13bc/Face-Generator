...
# * The photo angles are different. I wonder if having all photos taken from a similar angle would make it easier for the network to train and too learn that faces are usually more or less symmetrical.
# * The images are of very low resulution, which makes it harder to add more CNN layers.
#  * But I could still add residual blocks.
# * I could also try using label smoothing for the discriminator
